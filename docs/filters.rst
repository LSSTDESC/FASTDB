...
This section will cover how to create new filters at the broker level for FASTDB to subscribe to. 
...
This will load in the test dataset in ``datatest/rubin_test_data_10_0.parquet`` and use that to test your filter. If this dataset doesn't contain representative data for your test, you can `download your own data from the Fink Data Transfer service and add it in <https://doc.lsst.fink-broker.org/developers/filter_tutorial/#need-more-representative-test-data>`_.
